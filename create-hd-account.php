...
<main class="flex-shrink-0">
  <div class="container">
    ...
    <h1 class="mt-3">Create New HD Account</h1>
    <p class="lead"> Create New HD Account programmatically.</p>
   
        <form action="create-hd-account.php" method="POST">
            ...
            <div class="col-12">
                <input class="btn btn-primary" type="submit" name="create_hd_account" value="Create HD Account">
            </div>
        </form>

        <?php
            if (isset($_POST['create_hd_account'])) 
            {
                ...
                {   
                    ...
                    $label    = $_POST['label'];
                    $url = 'http://localhost:3000/merchant/9215bd73-32d6-4b9a-9427-e974fb032673/accounts/create';
                    ...
                    curl_setopt($ch, CURLOPT_POSTFIELDS, "label=".$label."&password=".$password);
                    ...
                    echo "Your account Label: ".$output['label']." <br/>";
                    echo "Your xpriv is : ".$output['xpriv']." <br/>";
                }else 
                {
