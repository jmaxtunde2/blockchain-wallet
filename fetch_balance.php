...
<main class="flex-shrink-0">
  <div class="container">
    ...
    <h1 class="mt-3">Fetch Balance</h1>
    <p class="lead"> Fetch the balance of a wallet.</p>
   
        <form action="fetch_balance.php" method="POST">
            ...
            <div class="col-12">
                <input class="btn btn-primary" type="submit" name="balance" value="Fetch Balance"/>
            </div>
        </form>
        ...
        <?php
            if (isset($_POST['balance'])) 
            {
                ...
                {   
                    ...
                    //
                    $url = "http://localhost:3000/merchant/$guid/balance";
                    //
                    ...
                    echo "Your Balance: ".$output['balance']." <br/>";
                }else 
                {
